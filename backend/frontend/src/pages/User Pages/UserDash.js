...
const UserDash = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    updateUser(user.userId, email, username, token)
      .then(data => {
        if (data.error) {
          setError(data.error)
          setSuccess(false)
      ...
      <div className=" mx-auto shadow">
        ...
        <div className="row my-5">
          <div className="col-6 shadow-sm p-2">
            ...
            <table className="table my-3 text-center  mx-auto w-75">
              <thead>
                <tr>
                  <th>S.No.</th>
                  <th>No. of items</th>
                  ...
                  myorders.map((item, i) => {
                    ...
                    return (
                      <tr key={i}>
                        ...
                        <td>
                          <Link
                            to={`/user/orderDetails/${item.orderId}`}
              ...
              <form className='mt-3 w-75 mx-auto'>
                ...
                <div className="mb-3 row">
                  ...
                  <div className="col-sm-10">
                    <input readOnly type="text" className="form-control" id="userid" value={user.userId} />
                  </div>
                </div>
                ...
                <div className="mb-3 row">
                  ...
                  <div className="col-sm-10">
                    <input type="text" className="form-control" id="username" placeholder={user.username} onChange={e => setUsername(e.target.value)} />
                  </div>
                </div>

                <button className='btn btn-danger mt-3' onClick={handleSubmit}>Update</button>
              </form>
